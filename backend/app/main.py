...
class User(Base):
    ...
    role = Column(String(32), nullable=False)  # 'traveler' | 'operator'
...
def create_or_update_rating(
    ...
    # Role policy: travelers rate operators, operators rate travelers
...
def discover(
    ...
    now = datetime.utcnow()
    # Subquery for active boost score per user
    active_boosts_sq = (
